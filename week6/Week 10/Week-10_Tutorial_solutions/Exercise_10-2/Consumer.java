...
class Consumer extends Thread 
{
  ...
  public void run() 
  {
    ...
    // int[] valuesConsumed = new int[ numberOfItems + 5 ] ;  // Exercise 10.2 (c).2
    int[] valuesConsumed = new int[ numberOfItems ] ;         // Exercise 10.2 
    int value = 0 ;


    for ( int i = 0; i < numberOfItems; i++ )   // Exercise 10.2 (a), (b), (c).1, (d)
    // for (int i = 0; i < numberOfItems + 5; i++)   // Exercise 10.2 (c).2
    {
      value = mailbox.take();
      ...
      int sleepTime = 500 ;           // Exercise 10.2 (a), (c), (d) 
      // int sleepTime = 1500 ;       // Exercise 10.2 (b) 500 or 1500
    ...
    for ( int i = 0; i < numberOfItems; i++ )              // Exercise 10.2  (a), (c).1, (d) 
    // for ( int i = 0; i < numberOfItems+5; i++ )         // Exercise 10.2 (c).2 
    {
